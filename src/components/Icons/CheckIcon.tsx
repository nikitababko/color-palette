...
export const CheckIcon: React.FC<IconProps> = () => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_598_10)">
                <mask id="mask0_598_10" maskUnits="userSpaceOnUse" x="0" y="0" width="24"
                      height="24">
                    <path
                    ...
                    <path d="M8 12L11 15L17 9" stroke="black" strokeWidth="2" strokeLinecap="round"
                          strokeLinejoin="round"/>
                </mask>
                <g mask="url(#mask0_598_10)">
